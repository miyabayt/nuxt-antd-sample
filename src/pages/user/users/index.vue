...
<script setup lang="ts">
  ...
  import { exportUserCsv, useUserSearch } from '@/services/users'
  ...
  const { isLoading, data: users } = useUserSearch(queryParams, pageInfo)
